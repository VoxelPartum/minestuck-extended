...
public class MSEConsumableProjectile extends ConsumableProjectileWeaponItem {

    public final SoundEvent sound;

    public MSEConsumableProjectile(Properties properties, float velocity, float accuracy, int damage, SoundEvent sound) {
