...
public class MSPBlockTagsProvider extends BlockTagsProvider {
    public MSPBlockTagsProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider, @Nullable ExistingFileHelper existingFileHelper) {
        super(output, lookupProvider, MinestuckPlus.MOD_ID, existingFileHelper);
    }
