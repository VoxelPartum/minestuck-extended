...
public final class MSPGristCostsProvider {
    ...
    public static void buildRecipes(RecipeOutput recipeSaver){
        ...
        GristCostRecipeBuilder.of(MSPItems.DIAMOND_LICHEN.get()).grist(DIAMOND, 1).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.SHADOW_CRYSTAL.get()).grist(AMETHYST,4).grist(TAR,5).grist(QUARTZ,1).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.ROULETTE_CARD.get()).grist(BUILD, 300).grist(COBALT, 25).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.BEAGLEPUSS.get()).grist(BUILD, 5).grist(AMBER, 1).grist(CHALK, 5).grist(IODINE, 1).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.TESTIFIPUSS.get()).grist(URANIUM, 5).grist(BUILD, 20).grist(SHALE, 5).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.BEAGLEPISS.get()).grist(AMBER, 50).grist(GOLD, 50).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.DISGUISE.get()).grist(BUILD, 20).grist(AMBER, 5).grist(CHALK, 20).grist(IODINE, 5).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.CINDERBLOCK.get()).grist(BUILD, 2).grist(CAULK, 2).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.ACABRICK.get()).grist(BUILD, 5).grist(SHALE, 5).grist(CHALK, 5).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.LANCER_COOKIE.get()).grist(AMBER, 1).grist(IODINE, 1).grist(COBALT, 1).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.DELTA_RUNE.get()).grist(AMBER, 1).grist(IODINE, 1).grist(COBALT, 1).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.ORANGE_CREAMSICLE.get()).grist(AMBER, 2).grist(GARNET, 2).grist(CHALK, 4).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.NORMAL_BROWNIE.get()).grist(AMBER, 4).grist(IODINE, 4).grist(URANIUM, 256).build(recipeSaver);

        //Weapons:
        GristCostRecipeBuilder.of(MSPItems.SHADOW_SWORD.get()).grist(BUILD, 250).grist(TAR, 25).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.SHOVEL_BLADE.get()).grist(BUILD, 1500).grist(COBALT, 413).grist(GOLD, 126).grist(DIAMOND, 50).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.ENERGY_SWORD.get()).grist(BUILD, 2250).grist(URANIUM, 450).grist(CHALK, 250).build(recipeSaver);

        GristCostRecipeBuilder.of(MSPItems.RUDE_AXE.get()).grist(BUILD, 400).grist(TAR, 25).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.ROCKSTARS_GUITAR.get()).grist(GARNET, 57).grist(BUILD, 580).grist(CHALK, 100).grist(AMBER, 50).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.SOULSPLITTER.get()).grist(DIAMOND, 500).grist(BUILD, 2065).grist(CHALK, 729).grist(TAR, 1430).build(recipeSaver);

        GristCostRecipeBuilder.of(MSPItems.WHIFFLEBAT.get()).grist(AMBER, 567).grist(BUILD, 479).grist(TAR, 37).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.METAL_PAN.get()).grist(BUILD, 662).grist(RUST, 631).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.HOMERUN_BAT.get()).grist(BUILD, 7213).grist(AMBER, 3799).grist(GARNET, 50).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.CLUB_SPIKED.get()).grist(BUILD, 90).grist(RUST, 22).grist(CAULK, 5).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.SPRING_MACE.get()).grist(BUILD, 4740).grist(RUST, 4897).grist(SHALE, 647).build(recipeSaver);

        GristCostRecipeBuilder.of(MSPItems.MARKET_GARDENER.get()).grist(RUST, 433).grist(CHALK, 375).grist(CAULK, 469).build(recipeSaver);

        GristCostRecipeBuilder.of(MSPItems.LANCER.get()).grist(CHALK, 77).grist(BUILD, 126).grist(COBALT, 413).build(recipeSaver);

        GristCostRecipeBuilder.of(MSPItems.DEVILS_KNIFE.get()).grist(TAR, 150).grist(SHALE, 276).grist(GOLD, 15).build(recipeSaver);

        GristCostRecipeBuilder.of(MSPItems.PRINCESS_WAND.get()).grist(SHALE, 126).grist(AMETHYST, 631).grist(AMBER, 100).build(recipeSaver);

        GristCostRecipeBuilder.of(MSPItems.SHEELD.get()).grist(ARTIFACT, 10).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.POGO_SHIELD.get()).grist(BUILD, 125).grist(SHALE, 15).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.MAGNET_SHIELD.get()).grist(BUILD, 24).grist(MERCURY, 19).grist(GARNET, 9).grist(RUST, 66).grist(DIAMOND, 11).grist(URANIUM, 41).build(recipeSaver);

        GristCostRecipeBuilder.of(MSPItems.CHESS_TILE.get()).grist(CHALK, 32).grist(TAR, 32).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.PLUSH_VRISKA.get()).grist(CHALK, 8).grist(COBALT, 8).grist(BUILD,8).build(recipeSaver);

        GristCostRecipeBuilder.of(MSPItems.SPIROGRAPH_ARMOR_TRIM.get()).grist(CHALK, 413).grist(URANIUM, 612).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.BREATH_ARMOR_TRIM.get()).grist(BUILD, 413).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.LIFE_ARMOR_TRIM.get()).grist(URANIUM, 413).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.LIGHT_ARMOR_TRIM.get()).grist(AMBER, 413).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.TIME_ARMOR_TRIM.get()).grist(IODINE, 413).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.HEART_ARMOR_TRIM.get()).grist(GARNET, 413).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.RAGE_ARMOR_TRIM.get()).grist(MARBLE, 413).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.BLOOD_ARMOR_TRIM.get()).grist(RUST, 413).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.DOOM_ARMOR_TRIM.get()).grist(MERCURY, 413).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.VOID_ARMOR_TRIM.get()).grist(COBALT, 413).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.SPACE_ARMOR_TRIM.get()).grist(TAR, 413).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.MIND_ARMOR_TRIM.get()).grist(DIAMOND, 413).build(recipeSaver);
        GristCostRecipeBuilder.of(MSPItems.HOPE_ARMOR_TRIM.get()).grist(GOLD, 413).build(recipeSaver);
